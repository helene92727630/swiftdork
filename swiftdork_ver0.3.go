...
"forums": {
	"generic": {
		"viewtopic.php?p=", "viewtopic.php?f=", "viewtopic",
		"viewforum.php?f=", "viewforum",
		"thread-", "showthread.php?tid=", "showthread.php?t=",
		"showthread.php?p=", "showthread.php?", "sendmessage.php?s=",
		"profile.php?mode=", "profile.php?id=",
		"posting.php?mode=", "post/post?f=", "post.php?fid=",
		"phpbb3/viewtopic.php?f=", "phpbb3/posting.php?mode=",
		"phorum2/read.php?", "phorum/read.php?",
		"newthread.php?s=", "newthread.php?fid=", "newthread.php?do=",
		"mode=phorum",
		"forumdisplay.php?f=", "forumdisplay.php?", "forumdisplay.php",
		"viewthread.php?tid=", "viewthread.php?",
		"vb/showthread.php?t=", "vb/showthread.php?",
		"showpost.php?p=", "showpost.php?", "printthread.php?tid=",
		"thread.php?tid=", "topic.php?id=", "topic.php?pid=",
		"forum.php?mod=viewthread&tid=", "forum.php?mod=forumdisplay&fid=",
		"forum.php?mod=post&action=reply&tid=", "forum.php?mod=post&action=newthread&fid=",
		"forum.php?mod=viewthread&tid=", "forum.php?mod=viewthread",
		"index.php?showtopic=", "index.php?act=ST&f=", "index.php?showforum=",
		"discussions.php?topic=", "index.php?topic=", "index.php?board=",
		"index.php?showtopic=", "index.php?showforum=",
		"view.php?id=", "view.php?f=",
		"posts.php?topic=", "posts.php?thread=", "topic.php?topic=",
	},
},
